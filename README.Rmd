...
Over-dispersion of the Binomial Mixture distributions obtained above for the Alcohol Consumption data.
...
The best-fitting distribution is chosen by comparing five main measurements shown in the above table 
...
absolute variance difference and AIC values.
...
also highest AIC value is for Triangular Binomial distribution. Based on the count of difference values for the
...
and AIC value of 1624.5534, the count of difference values is eight out of eight and indicates an estimated Over-dispersion
